...
```{r, eval=FALSE}
saveRDS(trainingDataMay25toMay31, file = "data/trainingDataMainAnalysisMay25toMay31.rds", compress = TRUE)
saveRDS(testDataMay28, file = "data/testDataMainAnalysisMay28.rds", compress = TRUE)
```
