...
fields::quilt.plot(
  x = simulatedDatasetsList$coords[ , "longitude"][observationsToPlot],
  y = simulatedDatasetsList$coords[ , "latitude"][observationsToPlot],
...
predictionSummariesByMethod <- analysePredResults(folderForSimResults = "outputFiles/", patternForFilename = "Dataset[[:digit:]]+\\.rds$", simulatedDataList = simulatedDatasetsList, obsIndicesForTraining = obsIndicesForTraining, shiftISMRApostPredVars = -errorSD^2)
